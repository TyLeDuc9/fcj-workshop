...
6. Triển khai **Amazon S3**.

+ Tạo S3 Bucket để lưu trữ hình ảnh và các tệp của hệ thống.
+ Cấu hình quyền truy cập phù hợp với ứng dụng.

*Chèn hình ảnh tạo Amazon S3 tại đây.*

---

8. Triển khai **Amazon ElastiCache for Redis**.
...
8. Triển khai **Application Load Balancer**.
...
10. Triển khai **AWS Secrets Manager**
